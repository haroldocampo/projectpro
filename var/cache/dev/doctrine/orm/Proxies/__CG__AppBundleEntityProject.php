...
class Project extends \AppBundle\Entity\Project implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'customer', 'number', 'enabled', 'dateTimeCreated', 'company', 'approver', 'costs', 'purchases'];
        }
    ...
    public function addCost(\AppBundle\Entity\Cost $cost)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCost', [$cost]);

        return parent::addCost($cost);
    }
    ...
    public function removeCost(\AppBundle\Entity\Cost $cost)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCost', [$cost]);

        return parent::removeCost($cost);
    }
    ...
    public function getPurchasesBetweenDate($dateStart, $dateEnd)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPurchasesBetweenDate', [$dateStart, $dateEnd]);

        return parent::getPurchasesBetweenDate($dateStart, $dateEnd);
    }
