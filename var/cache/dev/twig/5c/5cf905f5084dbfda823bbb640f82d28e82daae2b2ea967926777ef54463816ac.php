...
class __TwigTemplate_143a38300c6340a4652b1387fbe94f29fa90b5f46b8e1b37477b7339fe343d3c extends \Twig\Template
{
    private $source;
    ...
    ";
        ...
        echo "
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span>";
        // line 61
        echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "route", [], "any", true, true, false, 61)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "route", [], "any", false, false, false, 61), "NONE")) : ("NONE")), "html", null, true);
        echo "</span>
            </div>
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 267, $this->source); })()), "children", [], "any", false, false, false, 267))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                ...
                echo "                    <h3>
                        <a href=\"";
                // line 274
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", ["token" => twig_get_attribute($this->env, $this->source, $context["child"], "token", [], "any", false, false, false, 274)]), "html", null, true);
                echo "\">
                            ";
                // line 275
                echo $context["helper"]->macro_set_handler(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "getcollector", [0 => "request"], "method", false, false, false, 275), "controller", [], "any", false, false, false, 275));
                echo "
                        </a>
                        <small>(token = <a href=\"";
                // line 277
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["controller"] ?? null), "class", [], "any", true, true, false, 289)) {
                ...
                if ((isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 292, $this->source); })())) {
                    ...
                    echo "\" title=\"";
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["controller"]) || array_key_exists("controller", $context) ? $context["controller"] : (function () { throw new RuntimeError('Variable "controller" does not exist.', 292, $this->source); })()), "file", [], "any", false, false, false, 292), "html", null, true);
                    echo "\">";
                } else {
                    echo "<span>";
                }
...
{% macro set_handler(controller, route, method) %}
    ...
    {%- endif %}
{% endmacro %}
", "@WebProfiler/Collector/request.html.twig", "/Applications/MAMP/htdocs/projectpro-web/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/request.html.twig");
    }
}
