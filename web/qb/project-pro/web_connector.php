...
$user = 'quickbooks';
$pass = 'projectpro';
//$constring = 'mysqli://root:haroldhir@localhost/projectpro'; // local
...
$map = array(
	QUICKBOOKS_ADD_CUSTOMER => array('_quickbooks_customer_add_request', '_quickbooks_projectpro_response'),
	QUICKBOOKS_ADD_BILL => array('_quickbooks_bill_add_request', '_quickbooks_projectpro_response'),
	QUICKBOOKS_ADD_VENDORCREDIT => array('_quickbooks_credit_add_request', '_quickbooks_projectpro_response'),
	QUICKBOOKS_ADD_VENDOR => array('_quickbooks_vendor_add_request', '_quickbooks_projectpro_response'),
	QUICKBOOKS_ADD_CLASS => array('_quickbooks_class_add_request', '_quickbooks_projectpro_response'),
	QUICKBOOKS_ADD_NONINVENTORYITEM => array('_quickbooks_items_add_request', '_quickbooks_projectpro_response'),
	QUICKBOOKS_ADD_CREDITCARDCHARGE => array('_quickbooks_creditcardcharge_add_request', '_quickbooks_projectpro_response'),
	QUICKBOOKS_ADD_CREDITCARDCREDIT => array('_quickbooks_creditcardcredit_add_request', '_quickbooks_projectpro_response'),
	QUICKBOOKS_QUERY_ITEM => array('_quickbooks_item_query_request', '_quickbooks_item_query_response'),
	QUICKBOOKS_QUERY_VENDOR => array('_quickbooks_vendor_query_request', '_quickbooks_vendor_query_response'),
	QUICKBOOKS_QUERY_ACCOUNT => array('_quickbooks_account_query_request', '_quickbooks_account_query_response'),
	QUICKBOOKS_QUERY_CLASS => array('_quickbooks_class_query_request', '_quickbooks_class_query_response'),
...
$errmap = array(
	//3070 => 'projectpro_error_handler',
	'*' => 'projectpro_error_handler',				// Whenever a string is too long to fit in a field, call this function: _quickbooks_error_stringtolong()
